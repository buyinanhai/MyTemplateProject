...
#define TTextMessageCell_Text_Width_Max (kScreen_Width - TTextMessageCell_Text_PADDING)
...
#define TSystemMessageCell_Text_Width_Max (kScreen_Width * 0.5)
...
#define TJoinGroupMessageCell_Text_Width_Max (kScreen_Width * 0.5)
#define TJoinGroupMessageCell_Margin 5


//image cell
#define TImageMessageCell_ReuseId @"TImageMessageCell"
#define TImageMessageCell_Image_Width_Max (kScreen_Width * 0.4)
...
#define TFaceMessageCell_Image_Width_Max (kScreen_Width * 0.25)
...
#define TFileMessageCell_Container_Size CGSizeMake((kScreen_Width * 0.5), (kScreen_Width * 0.15))
...
#define TVideoMessageCell_Image_Width_Max (kScreen_Width * 0.4)
...
#define Record_Background_Size CGSizeMake(kScreen_Width * 0.4, kScreen_Width * 0.4)
