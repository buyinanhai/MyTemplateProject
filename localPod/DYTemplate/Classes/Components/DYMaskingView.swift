...
import UIKit
import Masonry
@objcMembers public class DYMaskingView: UIView {
    ...
    */
   public typealias CompeletedBlock = (_ result: Any?) ->Void
   public typealias OtherViewClick = (_ flag: Int) ->Void
    /**
     * 默认选中的数据
     */
    public var defaultData: Any?
   public var compeletedBlock: CompeletedBlock?
   public var otherClick: OtherViewClick?
   public var contentHeight: CGFloat = 250;
   public var pickerBackgroudColor = UIColor.white;
